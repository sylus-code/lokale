        ...
        return (
            <section className="showcase" id='offer'>
                <div className="container-fluid p-0">
                    <ImageShowcaseElement pic="image-case-2" even="true" message={dev}
                                          heading="Mieszkania deweloperskie"/>
                    <ImageShowcaseElement pic="image-case-4" even="false" message={sec}
                                          heading="Mieszkania z rynku wtórnego"/>
                </div>
            </section>
        );
    }
